...
app.post("/screenshot", async (req, res) => {
  ...
  await Promise.all([
    page.waitForNavigation(), // The promise resolves after navigation has finished
    page.goto("https://ftii2306.revvsales.com/documents/DOC-000040"), // Clicking the link will indirectly cause a navigation
  ]);
  await page.waitForTimeout(2000);
  ...
  await page.keyboard.type(`${req.body.studentName}`, { delay: 100 });
  await page.keyboard.press("Tab");

  await page.keyboard.type(`${req.body.studentClass}`, { delay: 100 });
  await page.keyboard.press("Tab");

  await page.keyboard.type(`${req.body.moneyPaid}`, { delay: 100 });
  await page.keyboard.press("Tab");
